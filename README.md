...
| Cloud Run deploy pipeline | `.github/workflows/deploy-cloudrun.yml` skips until you set the `GCP_PROJECT_ID` Actions variable. A deploy also needs the other GCP/WIF, Aiven, and mock-URL variables and secrets — see [Deployment](#deployment) |
